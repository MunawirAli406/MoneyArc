                    ...
                    {isOpen && (
                        <>
                            <motion.div
                                ...
                                animate={{ opacity: 1 }}
                                exit={{ opacity: 0 }}
                                className="fixed inset-0 z-[9998] bg-black/40 backdrop-blur-[4px]"
                            ...
                            <motion.div
                                ...
                                className="fixed z-[9999] bg-[#09090b] w-[320px] glass-panel rounded-3xl shadow-[0_30px_60px_-12px_rgba(0,0,0,0.5)] border border-primary/20 backdrop-blur-3xl"
                                style={{
                                    top: '50%',
                                    left: '50%',
                                    marginTop: 0
                                    ...
                                    <div className="space-y-4">
                                        {selectionType === 'Period' && (
                                            <div className="space-y-1.5">
                                                <label className="text-[10px] font-black uppercase tracking-widest text-primary/60 ml-1">From</label>
                                                <DatePicker
                                                    value={startDate}
                                        ...
                                        <div className={clsx("space-y-1.5", selectionType === 'Date' && "col-span-2")}>
                                            <label className="text-[10px] font-black uppercase tracking-widest text-primary/60 ml-1">
                                                {selectionType === 'Date' ? 'Selected Date' : 'To'}
                                            </label>
                                            <DatePicker
                                                value={endDate}
                                                onChange={setEndDate}
