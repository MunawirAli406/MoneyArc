    ...
    return (
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 relative overflow-hidden">
            ...
            >
                ...
                <div className="bg-white border border-slate-200 p-10 rounded-[2.5rem] shadow-2xl overflow-hidden relative">
                    ...
                    {!isInitialized ? (
                        ...
                        <div className="space-y-6">
                            <div className="bg-slate-50 border border-slate-200 p-6 rounded-[2rem] text-center">
                                ...
                                <h4 className="text-slate-900 font-bold mb-2">Initialize Data Vault</h4>
                                ...
                                <div className="space-y-4">
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative group">
                                            <Mail className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-primary transition-colors w-4 h-4" />
                                            <input
                                                type="email"
                                                required
                                                value={email}
                                                onChange={(e) => setEmail(e.target.value)}
                                                className="w-full pl-12 pr-4 py-4 bg-slate-50 border border-slate-200 rounded-2xl text-slate-900 outline-none focus:border-primary/50 focus:ring-4 focus:ring-primary/5 transition-all text-sm font-bold placeholder:text-slate-300"
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative group">
                                            <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-primary transition-colors w-4 h-4" />
                                            <input
                                                type="password"
                                                required
                                                value={password}
                ...
                <div className="mt-8 text-center space-y-4">
                    <p className="text-slate-400 text-sm font-medium">
                        Need to establish a new vault? <Link to="/signup" className="text-google-blue font-black hover:text-google-blue/70 transition-colors uppercase tracking-widest ml-1">Create Account</Link>
                    </p>
                </div>
            </motion.div>
