        ...
        <>
            ...
            {!isOpen && (
                <motion.button
                    ...
                    className="fixed bottom-6 right-6 p-4 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-full shadow-lg hover:shadow-xl text-white z-50 transition-all"
                >
